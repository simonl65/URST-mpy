...
SERIAL_BAUDRATE = 9600  # Must be one of the keys in baudrates
...
XBEE_BASE_NODEID = "BASE"  # NI (0-20 ASCII characters)
XBEE_DEVICE_NODEID = "DEVICE"  # NI

XBEE_POWER_LEVEL = 0  # PL (0: Lowest, 1: Low, 2: Medium, 3: High, 4: Highest)
